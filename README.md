...
|visible_angle||(table)||
||"min"/"max"|(number)|values for viewing angle for which the waypoint should be visible|
|visible_distance|(table)||
||"min"/"max"|(number)|values for a distance range for which the waypoint should be visible|
